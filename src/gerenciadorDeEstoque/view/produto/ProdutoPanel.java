...
public class ProdutoPanel extends JPanel {
	...
	public ProdutoPanel(Main main) {
        ...
        springLayout.putConstraint(SpringLayout.NORTH, tableProdutos, 6, SpringLayout.SOUTH, btnPesquisar);
        springLayout.putConstraint(SpringLayout.WEST, tableProdutos, 10, SpringLayout.WEST, this);
        springLayout.putConstraint(SpringLayout.SOUTH, tableProdutos, -6, SpringLayout.NORTH, btnVoltar);
        springLayout.putConstraint(SpringLayout.EAST, tableProdutos, 0, SpringLayout.EAST, btnExcluir);
        add(tableProdutos);
    }
}
